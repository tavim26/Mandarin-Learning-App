...
const TeacherProfile = () => {
  ...
  // Incarca titlul curent al profesorului
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        // Titlul ramane gol daca nu exista
      }
    };
    fetchProfile();
  }, [userId]);
  ...
  const handleUpdateInfo = async () => {
    ...
    try {
      ...
      // Actualizeaza titlul intotdeauna (poate fi sters sau modificat)
