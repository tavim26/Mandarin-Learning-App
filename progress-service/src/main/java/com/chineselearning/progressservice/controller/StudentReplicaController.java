...
public class StudentReplicaController {
    ...
    @Operation(summary = "Get global leaderboard",
            description = "Returns top 10 students by total XP across all lessons")
    ...
    @Operation(summary = "Get student progress summary",
            description = "Returns student XP total and level")
    ...
    @Operation(summary = "Check if student replica exists",
            description = "Returns true if student has submitted at least one attempt (replica created)")
    ...
    @Operation(summary = "Get all student replicas (admin)",
            description = "Returns all student progress summaries - for admin/debugging purposes")
