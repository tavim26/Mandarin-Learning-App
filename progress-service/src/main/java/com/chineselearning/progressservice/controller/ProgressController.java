...
public class ProgressController {
    ...
    @Operation(summary = "Submit exercise attempt",
            description = "Submit student answer for evaluation. Automatically creates student replica on first attempt (lazy creation).")
    ...
    @Operation(summary = "Get all attempts for exercise",
            description = "Returns all attempts made by a student on a specific exercise, ordered by attempt number")
    ...
    @Operation(summary = "Get lesson progress",
            description = "Returns progress for a specific lesson (completion %, status, XP awarded)")
    ...
    @Operation(summary = "Get all progress for student",
            description = "Returns all lesson progress records for a student")
    ...
    @Operation(summary = "Get in-progress lessons",
            description = "Returns only lessons with status IN_PROGRESS for a student")
    ...
    @Operation(summary = "Get lesson leaderboard",
            description = "Returns top 10 students by completion percentage for a specific lesson")
